...
export default function RankContainer() {
  ...
  if (isLoading) {
    return <S.Container><S.PageTitle>포인트 랭킹</S.PageTitle><div>로딩 중...</div></S.Container>;
  }
  if (isError || !data) {
    return <S.Container><S.PageTitle>포인트 랭킹</S.PageTitle><div>랭킹 정보를 불러올 수 없습니다.</div></S.Container>;
  }
